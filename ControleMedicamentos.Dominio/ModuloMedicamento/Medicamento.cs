...
namespace ControleMedicamentos.Dominio.ModuloMedicamento
{
    ...
    {        
        ...
        public Medicamento(string nome, string descricao, string lote, DateTime validade, int quatidadeDisponivel, Fornecedor fornecedor)
        {
            Nome = nome;
            Descricao = descricao;
            Lote = lote;
            ...
            QuantidadeDisponivel = quatidadeDisponivel;
